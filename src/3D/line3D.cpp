...
Point3D Line3D::GetIntersection(const Line3D &second_line) const {
    double denominator_x = (this->vect_direction.x2 * second_line.vect_direction.x1 -
                            second_line.vect_direction.x2 * this->vect_direction.x1);
    double denominator_y = (this->vect_direction.x1 * second_line.vect_direction.x2 -
                            second_line.vect_direction.x1 * this->vect_direction.x2);
    double denominator_z = (this->vect_direction.x2 * second_line.vect_direction.x3 -
                            second_line.vect_direction.x2 * this->vect_direction.x3);

    if (denominator_x * denominator_y * denominator_z == 0)
        return Point3D(INF, INF, INF);

    Point3D point;
    point.x = (this->M.x * this->vect_direction.x2 * second_line.vect_direction.x1 -
               second_line.M.x * second_line.vect_direction.x2 * this->vect_direction.x1
               - this->M.y * this->vect_direction.x1 * second_line.vect_direction.x1 +
               second_line.M.y * this->vect_direction.x1 * second_line.vect_direction.x1) / denominator_x;
    point.y = (this->M.y * this->vect_direction.x1 * second_line.vect_direction.x2 -
               second_line.M.y * second_line.vect_direction.x1 * this->vect_direction.x2
               - this->M.x * this->vect_direction.x2 * second_line.vect_direction.x2 +
               second_line.M.x * this->vect_direction.x2 * second_line.vect_direction.x2) / denominator_y;
    point.z = (this->M.z * this->vect_direction.x2 * second_line.vect_direction.x3 -
               second_line.M.z * second_line.vect_direction.x2 * this->vect_direction.x3
               - this->M.y * this->vect_direction.x3 * second_line.vect_direction.x3 +
               second_line.M.y * this->vect_direction.x3 * second_line.vect_direction.x3) / denominator_z;
